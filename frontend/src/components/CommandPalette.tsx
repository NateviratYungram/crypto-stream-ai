...
export const CommandPalette = ({ open, onClose, onNavigate }: Props) => {
  ...
  const COMMANDS: CommandItem[] = [
    ...
    { id: 'rag-ops', label: 'RAG Ops', sublabel: 'Reranking, A/B tests, feedback, latency and cost', icon: Brain, category: 'Navigation', keywords: ['rag', 'retrieval', 'annotation', 'feedback', 'rerank', 'tenant'], action: () => { onNavigate('RAG Ops'); onClose(); } },
